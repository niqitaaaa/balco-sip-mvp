...
const NAV_ADMIN = [
  ...
  { id: 'roi', label: 'ROI Calculator', icon: CalcIcon },
];
...
function CalcIcon({ className }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 14h.01M12 17h.01" />
